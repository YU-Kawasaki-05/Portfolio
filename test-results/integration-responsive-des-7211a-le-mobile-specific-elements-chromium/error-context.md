  ...
  - table:
    - rowgroup:
      - row "プロジェクト名 アクション":
        ...
        - cell "アクション"
    - rowgroup:
      - row "Neo-Typographic Fusion Portfolio 3Dタイポグラフィとモダンデザインを融合させたポートフォリオサイト 詳細を見る":
      ...
      - row "Interactive 3D Gallery WebGLを使用したインタラクティブな3Dギャラリーアプリケーション 詳細を見る":
      ...
      - row "Motion Design Website Framer Motionを活用したアニメーション豊富なWebサイト 詳細を見る":
